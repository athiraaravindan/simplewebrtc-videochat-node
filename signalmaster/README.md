...
3) In the console you will see a message which tells you where the server is running:
                        ...
                        "signal master is running at: http://localhost:"
...
To run the image execute this:  
    ...
    docker run --name signalmaster -d -p :8888 signalmaster

This will start a signal master server on port  exposed on port 8888.
